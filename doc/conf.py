# -*- coding: utf-8 -*-
#
# gplearn2 documentation build configuration file, created by
...
latex_documents = [
  ('index', 'gplearn2.tex', u'gplearn2 Documentation',
...
man_pages = [
    ('index', 'gplearn2', u'gplearn2 Documentation',
     [u'Trevor Stephens'], 1)
]
...
texinfo_documents = [
  ('index', 'gplearn2', u'gplearn2 Documentation',
   u'Trevor Stephens', 'gplearn2', 'One line description of project.',
   'Miscellaneous'),
]
